      ...
      `}>
        <div className="flex items-center gap-3 mb-12 px-2 group cursor-pointer" onClick={() => router.push('/')}>
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-[#4F7C82] uppercase tracking-[0.2em] opacity-60 leading-none mt-1">Super Admin</p>
            </div>
        </div>
        ...
        <div className="mt-auto pt-6 border-t border-[#4F7C82]/10 space-y-4">
          ...
          >
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-black text-[#0B2E33] truncate">{user?.name || 'Super Admin'}</span>
              <span className="text-[10px] font-bold text-[#4F7C82] truncate uppercase tracking-widest opacity-60">System Admin</span>
            </div>
          </div>
