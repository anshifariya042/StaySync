                        ...
                        <div key={hostel._id} className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.04)] hover:translate-y-[-5px] hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] transition-all border border-border-color p-4 flex flex-col">
                            ...
                            <div className="flex flex-col flex-grow">
                                ...
                                <Link 
                                    ...
                                    className="w-full py-3 bg-transparent border border-border-color rounded-lg font-semibold text-[0.95rem] text-foreground hover:bg-[#f9fafb] hover:border-[#d1d5db] transition-all cursor-pointer text-center block"
                                >
                                    View Details
                                </Link>
                            </div>
